...
{{ javascript_include("js/allDataTable.js")}}
       ...
       $( '.Kode_tab1', document.li ).click(function() {
        $('#revenue_chart_perbulan').empty();
         $.ajax({
              method: "POST",
              dataType: "html",
              url: "{{url('Graphic/getGraphicFilterPerbulan')}}",
              data: {
                 "Kode": $(this).data("id")
              },
              success: function(result){
    ...
    $("#Pertahun").click(function(){
      $(".ubah_grafik").attr("id","revenue_chart_pertahun");
        $('#revenue_chart_pertahun').empty();
            ...
            method: "POST",
            dataType: "html",
            url: "{{url('Graphic/getGraphicPertahun')}}",
            data: {
               "Kode": $(this).data("id")
            },
            success: function(result){
       ...
       $( '.Kode_tab1', document.li ).click(function() {
        $('#revenue_chart_pertahun').empty();
         $.ajax({
              method: "POST",
              dataType: "html",
              url: "{{url('Graphic/getGraphicFilterPertahun')}}",
              data: {
                 "Kode": $(this).data("id")
              },
              success: function(result){
